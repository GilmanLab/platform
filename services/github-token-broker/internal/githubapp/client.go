...
type AppConfig struct {
	...
	ClientID string
	// InstallationID is the GitHub App installation ID for GilmanLab/secrets.
	InstallationID string
	// PrivateKeyPEM is the GitHub App private signing key in PEM format.
	PrivateKeyPEM string
}

// Target describes the fixed installation-token request.
type Target struct {
...
// CreateInstallationToken mints an installation token for the fixed target repository.
